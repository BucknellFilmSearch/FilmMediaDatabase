...
export default class Footer extends React.Component {
    ...
    render() {
        ...
        const projectActions = [
            <FlatButton label='Close' primary={ true } onTouchTap={ this.handleCloseProject } />
        ];
        ...
        const aboutActions = [
            <FlatButton label='Close' primary={ true } onTouchTap={ this.handleCloseAbout } />
        ];
        ...
        return (
            <div id='footer'>
              ...
              <Dialog title='About the Project' actions={ projectActions } modal={ false } open={ this.state.openProject } autoScrollBodyContent={ true }
              ...
              <Dialog title='About Us' actions={ aboutActions } modal={ false } open={ this.state.openAbout } autoScrollBodyContent={ true } onRequestClose={ this.handleCloseAbout }>
